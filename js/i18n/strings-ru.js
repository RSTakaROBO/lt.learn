...
export const STR = {
    ...
    changelog: {
        ...
        previous: [
            {
                title: "Режим предложений",
                text: "Добавлен режим «Предложения»: нужно собирать литовский перевод из набора слов, среди которых есть лишние.",
            },
            {
                title: "Экран поиска слов",
                text: "Добавлен поиск по словарям: можно быстро найти слово, посмотреть перевод, формы и дополнительные данные.",
            },
        ],
    },
