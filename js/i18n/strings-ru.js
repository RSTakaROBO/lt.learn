...
export const STR = {
    ...
    help: {
        ...
        pinOff: "Выкл.",
        unpin: "Открепить",
        unpinCase: "Открепить падеж",
        dockedCasesAria: "Закреплённые правила падежей",
        unpinVerbTense: "Открепить правило времени",
        dockedVerbTensesAria: "Закреплённые правила времён глагола",
        openPinConfigurator: "Настроить боковые виджеты",
        pinConfiguratorTitle: "Закрепить правило",
        pinConfiguratorCases: "Падежи",
        pinConfiguratorTenses: "Времена",
        pinConfiguratorRule: "Правило",
        pinConfiguratorSide: "Расположить",
        pin: "Закрепить",
        tableStem: "Основа",
        tableSg: "Ед. ч.",
        tablePl: "Мн. ч.",
    ...
    changelog: {
        ...
        current: [
            {
                title: "Закреплённые правила на компьютере",
                text: "В широком десктопном режиме правила падежей и времён можно закреплять слева или справа от основного экрана. Управление доступно из справки и через кнопку-пин в верхнем углу.",
            },
        ],
        ...
        previous: [
            {
                title: "Формы ягод",
                text: "Уточнены словарные формы и падежи названий ягод: в карточках теперь используются формы множественного числа.",
            },
            {
