...
export const STR = {
  ...
  mode: {
    ...
    casesDesc: "Ввод формы слова в выбранном падеже",
    vocabTitle: "Изучение слов",
    vocabDesc: "Выбор перевода после наборов и шага «Направление»",
  },
  ...
  vocabDirection: {
    ...
    hardcoreMeta: "Ввод слова вручную: поле ответа и кнопки литовских букв (без вариантов выбора)",
  },
  ...
  quiz: {
    ...
    noVocabUi: "Не удалось открыть режим «Слова». Обновите страницу или очистите данные сайта / кэш приложения.",
  ...
  help: {
    ...
    tablePl: "Мн. ч.",
    vocativeNote:
      "Мн. ч. звательного часто совпадает с именительным мн. ч. У −ys звательный ед. ч. часто на −iau (<i lang=\"lt\">arklys</i> — <i lang=\"lt\">arkliau</i>), но бывают слова на <span lang=\"lt\">−y</span>.",
    verbsTitleHtml: 'Справка: <span lang="lt">yra</span> и <span lang="lt">nėra</span>',
    verbsPresent: "Настоящее время",
    verbsColPerson: "Лицо",
    verbsColAffirm: "Утверждение",
    verbsColNeg: "Отрицание",
    verbsNoteHtml:
      'В 3-м лице <span lang="lt">yra</span> и <span lang="lt">nėra</span> совпадают для единственного и множественного числа.',
    verbsRow1: "я",
    verbsRow2: "ты",
    verbsRow3: "он / она",
    verbsRow4: "мы",
  ...
  helpHub: {
    ...
    verbsBtnHtml: 'Справка: <span lang="lt">yra</span> / <span lang="lt">nėra</span>',
    close: "Закрыть",
  },
  ...
  packPrompt: {
    ...
    lead:
      "Скопируйте текст и вставьте в чат с LLM. Ответ сохраните как файл .json и загрузите в тренажёр через «Загрузить свой JSON…».",
  ...
  events: {
    ...
    vocabNeedRuFour: "Для «Изучение слов» нужно минимум 4 слова с русским переводом в выбранных наборах.",
    ...
    loadFailed: "Ошибка загрузки: {message}. Откройте сайт через локальный сервер в папке проекта (fetch к файлам с file:// часто блокируется).",
  ...
  errors: {
    ...
    jsonNeedWords: "Нужно поле «words» — массив статей с формами слова.",
