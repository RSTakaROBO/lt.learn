...
export const els = {
  ...
  packJsonInput: document.getElementById("pack-json-input"),
  btnPackPromptHelp: document.getElementById("btn-pack-prompt-help"),
  ...
  helpHubOverlay: document.getElementById("help-hub-overlay"),
  btnHelpHub: document.getElementById("btn-help-hub"),
  btnHelpHubClose: document.getElementById("btn-help-hub-close"),
  btnHelpHubCases: document.getElementById("btn-help-hub-cases"),
  btnHelpHubVerbs: document.getElementById("btn-help-hub-verbs"),
  ...
  packPromptOverlay: document.getElementById("pack-prompt-overlay"),
  packPromptTitle: document.getElementById("pack-prompt-title"),
  packPromptTextarea: document.getElementById("pack-prompt-text"),
  btnPackPromptCopy: document.getElementById("btn-pack-prompt-copy"),
  btnPackPromptClose: document.getElementById("btn-pack-prompt-close"),
