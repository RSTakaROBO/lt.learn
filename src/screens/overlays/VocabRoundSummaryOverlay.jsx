...
export function VocabRoundSummaryOverlay({ heightMode = "fill" } = {}) {
  ...
  return (
    <AppModalOverlay
      ...
      title={
        <h2 id="vocab-round-summary-title">{VR.summaryTitle}</h2>
      }
      footer={
          ...
          <div className="vocab-round-summary-body">
            <div className="vocab-round-summary-stats-card" aria-live="polite">
              <div className="vocab-round-summary-stat-row">
                <span className="vocab-round-summary-stat-label">{VR.statAccuracy}</span>
                <div className="vocab-round-summary-stat-val">
                  {snap.accuracyPct == null ? (
                    <span className="vocab-round-summary-stat-num">{STR.quiz.emDash}</span>
                  ) : (
                    <>
                      <span className="vocab-round-summary-stat-num vocab-round-summary-stat-num--accent">
                        {snap.accuracyPct}
                      </span>
                      <span className="vocab-round-summary-stat-unit" aria-hidden="true">
                        {VR.percentUnit}
                      </span>
                    </>
                  )}
              ...
              <div className="vocab-round-summary-stat-row">
                <span className="vocab-round-summary-stat-label">{VR.statMaxStreak}</span>
                <div className="vocab-round-summary-stat-val">
                  <span className="vocab-round-summary-stat-num vocab-round-summary-stat-num--accent">
                    {snap.maxStreak}
                  </span>
              ...
              {snap.topHard.length === 0 ? (
                ...
                <div className="vocab-round-summary-table-scroll">
                  <table className="vocab-round-summary-table">
                    ...
                    <thead>
                      <tr>
                        <th scope="col" className="vocab-round-summary-th vocab-round-summary-th--num">
                          {VR.thNum}
                        </th>
                        <th scope="col" className="vocab-round-summary-th vocab-round-summary-th--word">
                          {VR.thWord}
                        </th>
                        <th scope="col" className="vocab-round-summary-th vocab-round-summary-th--err">
                          {VR.thErr}
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {snap.topHard.map((x, i) => (
                        <tr key={x.lemma}>
                          ...
                          <td className="vocab-round-summary-td vocab-round-summary-td--word" lang="lt">
                            {x.lemma}
                          </td>
